...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-200 via-orange-300 to-green-400 flex items-center justify-center">
      <div className="bg-zinc-300 bg-opacity-75 rounded-lg shadow-lg p-4 max-w-md w-full space-y-8 flex relative">
        {/* Pentagon shape */}
        <div className="fixed m-28 flex items-center pointer-events-none z-10">
          <svg
          ...
          <form className="mt-2 space-y-6" action="#" method="POST">
            <div>
              <input
                ...
                required
                className="block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-gray-100"
              />
            </div>
        ...
        <div className="w-1/2 flex justify-center items-center z-10">
          <img
            src="/Women pic.png"
            alt="Doctor Image"
            className="w-30 h-30 ml-4 object-cover rounded-lg shadow-lg"
          />
        </div>
      </div>
    </div>
